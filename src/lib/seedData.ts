...
export const RESOURCE_ITEMS: ResourceItem[] = [
  ...
  },
  {
    ...
    contentType: "article",
    attribution: "Parish editorial team",
    attributionRo: "Echipa editorială a parohiei",
    body: [
  ...
  },
  {
    ...
    contentType: "video",
    durationLabel: "24:00",
    attribution: "Parish media ministry",
    attributionRo: "Departamentul media al parohiei",
  },
  {
    id: "res-videos-2",
    category: "videos",
...
export const PARISHES: Parish[] = [
  ...
  },
  {
    ...
    patronSaint: "Sf. Mare Mucenic Gheorghe",
    city: "Houston",
    state: "Texas",
    country: "SUA",
    jurisdiction: "ROEA",
  ...
  {
    id: "sf-trei-ierarhi-munchen",
    name: "Parohia Ortodoxă Română „Sfinții Trei Ierarhi”",
    patronSaint: "Sfinții Trei Ierarhi",
    city: "München",
    state: "Bavaria",
    country: "Germania",
    jurisdiction: "Mitropolia Ortodoxă Română a Europei Occidentale și Meridionale",
    address: "Salvatorplatz 3",
    latitude: 48.1417,
    longitude: 11.5764,
    phone: "+49 89 555 0142",
    email: "biroul@parohia-munchen.de",
    website: "parohia-munchen.de",
    clergy: [{ name: "Pr. Paroh Andrei Vasilescu", role: "Parish Priest", roleRo: "Preot paroh" }],
    schedule: SUNDAY_SCHEDULE,
    verifiedAt: "2025-04-10",
  },
  {
    id: "sf-nicolae-milano",
    name: "Parohia Ortodoxă Română „Sf. Nicolae”",
    patronSaint: "Sf. Ierarh Nicolae",
    city: "Milano",
    state: "Lombardia",
    country: "Italia",
    jurisdiction: "Mitropolia Ortodoxă Română a Italiei",
    address: "Via Cimarosa 6",
    latitude: 45.4685,
    longitude: 9.1824,
    phone: "+39 02 555 0198",
    email: "parohia@ortodoxia-milano.it",
    website: "ortodoxia-milano.it",
    clergy: [{ name: "Pr. Paroh Constantin Ionescu", role: "Parish Priest", roleRo: "Preot paroh" }],
    schedule: SUNDAY_SCHEDULE,
    verifiedAt: "2025-03-22",
  },
  {
    id: "nasterea-domnului-london",
    name: "Parohia Ortodoxă Română „Nașterea Domnului”",
    patronSaint: "Nașterea Domnului",
    city: "Londra",
    state: "Anglia",
    country: "UK",
    jurisdiction: "Arhiepiscopia Ortodoxă Română a Europei Occidentale",
    address: "Radnor Walk 12",
    latitude: 51.4875,
    longitude: -0.1687,
    phone: "+44 20 555 0176",
    email: "office@biserica-londra.org.uk",
    website: "biserica-londra.org.uk",
    clergy: [{ name: "Fr. Mihail Popa", role: "Parish Priest", roleRo: "Preot paroh" }],
    schedule: SUNDAY_SCHEDULE,
    verifiedAt: "2025-04-02",
  },
  {
    id: "sf-maria-paris",
    name: "Paroisse Orthodoxe Roumaine „Sainte Marie”",
    patronSaint: "Adormirea Maicii Domnului",
    city: "Paris",
    state: "Île-de-France",
    country: "Franța",
    jurisdiction: "Mitropolia Ortodoxă Română a Europei Occidentale și Meridionale",
    address: "Rue Jean de Beauvais 9",
    latitude: 48.8496,
    longitude: 2.3469,
    phone: "+33 1 555 0165",
    email: "contact@paroisse-paris.fr",
    website: "paroisse-paris.fr",
    clergy: [{ name: "Pr. Paroh Gabriel Stoica", role: "Parish Priest", roleRo: "Preot paroh" }],
    schedule: [],
    verifiedAt: "2025-03-30",
  },
];
...
export const EVENTS: EventItem[] = [
  ...
  },
  {
    ...
    category: "diocesan",
    description: "The annual Diocesan Assembly bringing together clergy and lay delegates from across the diocese.",
    descriptionRo: "Adunarea Eparhială anuală, care reunește clerici și delegați mireni din întreaga eparhie.",
    startDate: "2026-11-15",
    endDate: "2026-11-15",
    location: "Chicago, IL",
    status: "upcoming",
